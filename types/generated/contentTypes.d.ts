...
export interface ApiContactRequestContactRequest
  ...
  attributes: {
    ...
    postcode: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    serviceRequired: Schema.Attribute.Enumeration<
      [
        'Immediate Emergency Fitting',
        'Premium Tyre Service',
        'Puncture Repair',
        'Mobile Trailer Tyre Fitting',
        'Wheel Balancing',
...
export interface ApiTyreTyre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tyre.tyre'> &
      Schema.Attribute.Private;
    price: Schema.Attribute.Integer;
    productClass: Schema.Attribute.Enumeration<
